...
const int char_to_enum_lookup_table[]={[0 ... LAST_USEFUL_CHAR]=-1,[DIAMOND_CHAR]=diamonds,[GOLD_CHAR]=golds,[SILVER_CHAR]=silvers,[SPICE_CHAR]=spices,[CLOTH_CHAR]=cloths,[LEATHER_CHAR]=leathers,[CAMEL_CHAR]=camels};
